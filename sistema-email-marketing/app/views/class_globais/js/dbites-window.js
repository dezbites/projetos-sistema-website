...
function wind(valo,vls){
    ...
    if(vls){
        ...
        fundp.setAttribute("style",`margin-top:-150px;opacity:0;padding:10px;border-radius:7px 7px 0px 0px;border-top:40px solid #5cc1bd;width:60vw;height:50vh;background-color:#fff;box-shadow:0px 0px 30px
